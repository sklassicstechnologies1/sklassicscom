...
//         }}
//         key={`bg-${current}`} // Add key to force re-render
//       />
        ...
        >
          ...
          <div className="flex justify-center md:justify-start">
            <button 
              ...
              className="group bg-[#eb8603] hover:bg-[#eb8603] text-white font-medium sm:font-bold py-2 px-4 md:py-3 md:px-6 rounded-md transition-all duration-300 flex items-center text-sm sm:text-base"
            >
              <span className="relative flex items-center">
                Explore Courses
