    ...
    <>
      ...
      >
        ...
        <div className="relative z-20 max-w-4xl">
         ...
         <li> Learn from Experts: Gain insights and knowledge from industry professionals who are leaders in the field.</li>

         <li>Certification: Get certified as a Big Data expert to boost your career prospects.</li>

         <li>Real Projects: Work on real-world projects using industry-standard tools and techniques.</li>

         <li>100-Day Program: Engage in a comprehensive 100-day certification program with practical exercises and projects.</li>

         <li>Skill Mastery: Master essential skills such as data analysis, data engineering, big data technologies, and implementation.</li>
          </ul>
          {/* <h3>
            <strong>
           Course Duration : 
