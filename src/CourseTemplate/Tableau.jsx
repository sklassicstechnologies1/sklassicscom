    ...
    <>
      ...
      >
        ...
        <div className="relative z-20 max-w-4xl">
          ...
          Our comprehensive Tableau certification program, designed by data visualization experts, will equip you with the skills to become a Tableau master.

Learn from Tableau specialists who use the platform to create stunning visualizations for real businesses.

Work on practical data visualization projects to solidify your Tableau skills.

Master in-demand skills: Learn essential Tableau functionalities, data manipulation, chart creation, dashboard design, and best practices.

Gain proficiency in data preparation techniques to make your visualizations shine.
          </p>
          {/* <h3>
            <strong>
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
              <li> Bachelor’s Degree (Any Field): Your degree demonstrates strong communication and critical thinking skills, valuable assets for creating impactful data visualizations. Tableau training refines these skills within the context of data storytelling.</li>
              <li>Business or Data Analysis Background : If you have a degree in Business Administration, Statistics, or a related field, you’ll likely have a stronger foundation in data analysis and interpreting data sets. Tableau training builds upon this knowledge by focusing on visually representing that data.</li>
