...
//           <h1 className="text-5xl font-extrabold mb-10">Web Development</h1>
...
//                       </details>
//                     );
//                   } else if (item === "JavaScript Programming") {
//                     return (
//                       <details
//                         key={index}
//                         className="group border border-purple-800 rounded overflow-hidden"
...
//                             <li>JavaScript modules and bundlers</li>
//                           </ul>
//                         </div>
//                       </details>
//                     );
//                   } else if (item === "Responsive Web Design") {
//                     return (
//                       <details
//                         key={index}
//                         className="group border border-purple-800 rounded overflow-hidden"
