    ...
    <>
      ...
      >
        ...
        <div className="relative z-20 max-w-4xl">
          <h1 className="text-5xl font-extrabold mb-10">Data Analytics</h1>
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  if (item === "Introduction to Data Analytics") {
                    return (
                      <details
                        key={index}
                      ...
                      >
                        ...
                        <div className="bg-white px-4 py-3 text-gray-800 text-sm space-y-2">
                          <ul className="list-disc list-inside space-y-1">
                            <li>What is Data Analytics and its importance</li>
                  ...
                  } else if (item === "Data Collection and Preparation") {
                    return (
                      <details
                        key={index}
                        className="group border bg-[#4f1964] rounded overflow-hidden"
                      >
                        ...
                        <div className="bg-white px-4 py-3 text-gray-800 text-sm space-y-2">
                          <ul className="list-disc list-inside space-y-1">
                            ...
                            <li>Data integration and consolidation</li>
                          </ul>
                        </div>
                      </details>
                    );
                  } else if (item === "Exploratory Data Analysis (EDA)") {
                    return (
                      <details
                        key={index}
                        className="group border bg-[#4f1964] rounded overflow-hidden"
                      >
                        ...
                        <div className="bg-white px-4 py-3 text-gray-800 text-sm space-y-2">
                          <ul className="list-disc list-inside space-y-1">
                            <li>Data understanding and profiling</li>
                            <li>Univariate and bivariate analysis</li>
                            <li>Correlation analysis and heatmaps</li>
                  ...
                  } else if (item === "Statistical Analysis") {
                    return (
                      <details
                        key={index}
                        className="group border bg-[#4f1964] rounded overflow-hidden"
                      >
                        ...
                        <div className="bg-white px-4 py-3 text-gray-800 text-sm space-y-2">
                          <ul className="list-disc list-inside space-y-1">
                            <li>Descriptive statistics and measures</li>
                            ...
                            <li>Statistical software tools (R, Python)</li>
                          </ul>
                        </div>
                      </details>
                    );
